...
type UpdateSettingsRequest struct {
	...
	PaymentBalanceRechargeMinimum    *float64 `json:"payment_balance_recharge_multiplier_min"`
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	if h.paymentConfigService != nil && hasPaymentFields(req) {
		paymentReq := service.UpdatePaymentConfigRequest{
			...
			BalanceRechargeMinimum:        req.PaymentBalanceRechargeMinimum,
	...
	payload := dto.SystemSettings{
		...
		PaymentBalanceRechargeMinimum:                          updatedPaymentCfg.BalanceRechargeMinimum,
...
func hasPaymentFields(req UpdateSettingsRequest) bool {
	return req.PaymentEnabled != nil || req.PaymentMinAmount != nil ||
		...
		req.PaymentBalanceRechargeMultiplier != nil || req.PaymentBalanceRechargeMinimum != nil || req.PaymentSubscriptionUSDToCNYRate != nil ||
